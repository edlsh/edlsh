...
const enzo: Engineer = {
  role: "AI Engineer",
  focus: ["LLM Applications", "Cloud Infrastructure", "Automation"],
  currentlyBuilding: "MCP Servers & AI-powered tooling",
  philosophy: "Automate everything, secure everything, ship fast"
};
```
